module.exports = {
  config: {
    ...
    countDown: 5,
    role: 0,
    shortDescription: "gali",
    longDescription: "gali not allow",
    category: "auto ✅",
  },
...
    if (
      event.body &&
      [
        "মাগি", "খানকি মাগি", "bal", "Bal", "বাল", "Magi", "khanki", "sawya", "vudai", "fuck", "fuck you", "vodai", "Kha", "খানকি", "সাওয়া", "ভুদা", "ভোদা", "হেডা", "নুনু", "তোর মারে চুদি", "চুদি",
        "চোদ", "ভোদায়", "ভুদায়", "magi", "Khanki", "Saoya", "Sawya", "Vuda", "Voda", "Heda",
        "Noti", "Gud", "নটি", "Sudi", "Fuck you", "Fuck", "Vudai", "Vodai", "Abal", "আবাল", "গুদ", "Tor mare cudi", "Magir pola", "তোর মারে চুদি", "মাগির পোলা", "মাগী", "চুদ"
      ].includes(event.body.trim())
    ) {
...
      const msg = `hei gai ${name}\n▬▬▬▬▬▬▬▬▬▬▬▬\n\n😐গালি দিলে পাপ হয় বাইনচুদ🤬\n\n▬▬▬▬▬▬▬▬▬▬▬▬\n𝐓𝐢𝐦𝐞:【 ${date} || ${time}`;
